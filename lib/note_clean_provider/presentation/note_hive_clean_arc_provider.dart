...
class _NoteHiveCleanArcProviderState extends State<NoteHiveCleanArcProvider> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Hive CleanArc Provider" , style: TextStyle(color: Colors.white),),
  ...
  void openBottomSheet(BuildContext context, Size size) {
    showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return Padding(
            padding: EdgeInsets.only(bottom: MediaQuery  // to prevent cover bottomSheet by keyboard
                .of(context)
                .viewInsets
                .bottom),
            child: Container(
